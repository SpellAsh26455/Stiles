...
<script type="text/javascript" src="phaser.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    var hei="";
    var dataString="";
//    var gaaa1 = "<?php echo $name_ga; ?>";
  //  var gaaa = document.getElementById('gaaa').value;
   // var gos = gaaa1+"_"+gaaa;
        ...
        function setCardVillan(cardname)
        {
            ...
            var div1 = document.getElementById("closeVillan");
        ...
        function go(){
        /*var qwerty=document.getElementById("gaaa");
          if(querty==""||b=="")
          {
             if(qwerty=="")
          {
            alert("Enter the name of the game");
          }
          if(b=="")
          {
          ...
          {*/
          var g=value+b+"&"+i+"&"+p+"&"+v+"&"+canvastype+"&f=1";
          //alert(g);
        ...
        function forScore(name) 
        {
         ...
         function foo () {
          /*var qwerty=document.getElementById("gaaa").text;
          alert(querty);
          if(querty==""||b=="")
          {
             if(qwerty=="")
        ...
        {*/
          var g="CB.php?"+b+"&"+i+"&"+p+"&"+v+"&"+canvastype+"&f=0";
...
<body onload="cc()">
  ...
  <div class="wrap">
    <div class="fleft">
      <div class="bg">
            ...
            &nbsp;&nbsp;
            <img class="img" src="assets/pbsky.png" alt="Forest G" style="width:130px;height: 70px" onclick="setBackgroundForCanvas('pbsky.png')"><br>
            &nbsp;
        ...
        <div>
            ...
            <img class="img" src="assets/guystatic.png" alt="dancingDude" style="width:50px;height: 50px" onclick="setCardPlayer('guystatic.png')">
            &nbsp;&nbsp;
            ...
            &nbsp;&nbsp;
            <img class="img" src="assets/bird1.png" alt="dancingDude" style="width:50px;height: 50px" onclick="setCardPlayer('bird1.png')">&nbsp;&nbsp;
            <img class="img" src="assets/bird2.jpg" alt="i1" style="width:50px;height: 50px" onclick="setCardPlayer('bird2.jpg')">
            &nbsp;&nbsp;
        </div><hr/>
        ...
        <div>
            ...
            <img class="img" src="assets/a.png" alt="i1" style="width:50px;height: 50px" onclick="setCardIncentive('a.png')">
            &nbsp;&nbsp;
        ...
        <label> Enter Name Of Game <input type="text" name="gameofname" required id="gaaa"></label> 
    ...
    <div class="fright"><br><label>Canvas</label><br><br>
      ...
      <div class="card"><label>Selected :</label>
        <div>&nbsp;&nbsp;
        <div class="parentabc"><img id="playerpic" class="pic player img" alt="playerpic"><button id="closePlayer" class="closeabc" onclick="goclose('closePlayer','playerpic')">X</button>&nbsp;&nbsp;</div>
        <div class="parentabc"><img id="vpic" class="pic villan img"><button id="closeVillan" class="closeabc" onclick="goclose('closeVillan','vpic')">X</button>&nbsp;&nbsp;</div>
        <div class="parentabc"><img id="ipic" class="pic incentive img"><button id="closeInc" class="closeabc" onclick="goclose('closeInc','ipic')">X</button>&nbsp;&nbsp;</div>
      </div>
      </div><br>
  ...
  <div class="modal-content mCanvas">
    <span id="c1" class="close">&times;</span><br>
    <font size="26"><label>CHOOSE CANVAS TYPE</label></font><hr/><br><center>
...
<div id="myModal5" class="modal" style="padding-top: 15px;">
  ...
  <div class="modal-content  myModal5mc">
    <span id="c2" class="close">&times;</span>
    <br><br>&nbsp;<label>GAME</label><hr/><br><center>
    <div id="here">
      <div id="snakes"></div>
  </div></center>
</div>
