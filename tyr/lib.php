...
class lib 
{
	...
	{
		return "
		game = new Phaser.Game(600, 450, Phaser.AUTO, 'snakes');
		var Menu = {
		preload : function() {
...
";
	...
	public function setImage($imgname_p,$imgurl_p,$imgname_o,$imgurl_o,$imgname_bg,$imgurl_bg)
	{
		return "game.load.image('".$imgname_p."', '".$imgurl_p."');
		        game.load.image('".$imgname_o."', '".$imgurl_o."'); 
                game.load.image('".$imgname_bg."', '".$imgurl_bg."'); 
 			    },
    ...
    "; }
    public function update($speed)
    {
    	return "
            update: function() {
        //cursors.down.isDown
        // Handle arrow key presses, while not allowing illegal direction changes that will kill the player.
//        this.dir1 = game.input.keyboard.addKey(Phaser.Keyboard.D);
  //      this.dir2 = game.input.keyboard.addKey(Phaser.Keyboard.A);
    //    this.dir3 = game.input.keyboard.addKey(Phaser.Keyboard.W);
      //  this.dir4 = game.input.keyboard.addKey(Phaser.Keyboard.S);
        ...
        speed = Math.min(10, Math.floor(score/".$speed."));
